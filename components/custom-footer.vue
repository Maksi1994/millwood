  ...
  <div class="w-full bg-[#FAFAFA] lato lg:px-0 px-[16px] border-t border-solid border-[#ECEDEE]">
    <div class="py-[24px] lg:w-[996px] mx-auto flex lg:flex-row flex-col lg:gap-[42px] gap-[32px] justify-between">
      ...
      <div class="lg:w-auto w-[270px]">
        ...
        <ul>
          <li class="mb-[4px]">
            <nuxt-link to="/solution-1" exactActiveClass="!text-[#419B44] underline" class="text-[#464B57] leading-[22px] text-[14px] lato-m hover:text-[#419B44] hover:underline underline-offset-[3px]">
              Індустріальні будівлі
            </nuxt-link>
          </li>
          <li class="mb-[4px]">
            <nuxt-link to="/solution-2" exactActiveClass="!text-[#419B44] underline" class="text-[#464B57] leading-[22px] text-[14px] lato-m hover:text-[#419B44] hover:underline underline-offset-[3px]">
              Житлові будівлі
            </nuxt-link>
          </li>
          <li>
      ...
      <div class="lg:w-auto w-[270px]">
        <h1 class="text-[#464B57] text-[16px] lato-e mb-[12px] leading-[19px]">Контакти</h1>

        <ul>
          <li class="mb-[9px]">
            <a href="tel:+380 50 373 0203" class="text-[#419B44] text-[14px] lato-m hover:text-[#419B44] hover:underline underline-offset-[3px]">
              +380 50 373 0203
            </a>
          </li>
          <li>
            <a href="/" class="text-[#464B57] leading-[22px] text-[14px] lato-m hover:text-[#419B44] hover:underline underline-offset-[3px]">
              Мілвуд ТОВ
            </a>
          </li>
          <li>
            <a href="/" class="text-[#464B57] leading-[22px] text-[14px] lato-m hover:text-[#419B44] hover:underline underline-offset-[3px]">
              Заводська 4, смт. Вигода, Україна, 77552
            </a>
          </li>
        </ul>
      </div>
    </div>
    <div class="text-center bg-white h-[44px] flex items-center justify-center text-[#61656F] lato-s">
      © 2024 - Millwood LLC
    </div>
  </div>
</template>
