<template>
  <div class="py-[24px] px-[32px] bg-[#F4F9F4] flex justify-center gap-[62px]" >
      <div>
        <h1 class="text-[#464B57] text-[16px] lato-e mb-[12px] leading-[19px]">Будівельні концепції</h1>

        <ul>
          <li class="mb-[4px]">
            <a href="/" class="text-[#464B57] text-[14px] lato-m hover:text-[#419B44] hover:underline underline-offset-[3px]">
