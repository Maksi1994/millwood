<template>
  <div class="flex lg:py-[20px] py-[14px] items-center">
    ...
    <div class="gap-[20px] lg:flex hidden">
      <nuxt-link to="/about" class="text-[#464B57] text-[16px] lato-s lato">
        Про Мілвуд
      </nuxt-link>
      <nuxt-link to="/about" class="px-[14px] lato lato-s">
        Продукти і рішення
      </nuxt-link>
      <nuxt-link to="/strong" class="text-[#464B57] text-[16px] lato-s lato">
        Стійкість
      </nuxt-link>
      <nuxt-link to="/news" class="text-[#464B57] text-[16px] lato-s lato">
        Новини
      </nuxt-link>
    </div>

    <div class="lg:ml-20 ml-auto items-center flex">
      ...
      <div class="ml-[12px] py-[6px] pl-[7px] pr-[10px] border border-[#ECEDEE] border-solid cursor-pointer h-[42px]">
