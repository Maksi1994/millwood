  ...
  <div class="mt-[10px] w-full">
    ...
    <div class="mb-[24px]">
      ...
      <div class="flex flex-col gap-[2px]">
        <div class="flex">
          <div class="w-[232px] bg-[#419B44] text-white px-[10px] py-[12px] h-[54px] leading-[30px] lato-e">
            Товщина, мм:
          </div>

          <div class="w-full bg-[#E4F1E5] text-center h-[54px] lato-b text-[#464B57] leading-[54px]">
            45
          </div>
        </div>
