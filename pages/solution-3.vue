<template>
  ...
  <div class="mt-[24px] w-full">
    <div class="lg:h-[340px] h-[240px] w-full flex items-center bg-[#F4F9F4] bg-no-repeat bg-center relative lg:mb-[42px] bg-cover">
      ...
      <img class="lg:w-[325px] w-[208px] mx-auto object-center object-cover lg:ml-[187px]" src="/assets/img/solution-3.png" alt="">
    </div>
    ...
    <div class="mb-[48px]">
      ...
      <ul class="lg:text-[18px] text-[18px] lg:leading-normal leading-[18px] flex flex-col gap-[12px] text-[#61656F] lato-s list-disc lg:pl-[20px] pl-[15px] lg:mb-[24px] mb-[18px]">
        ...
        <li>Спортивні комплекси (басейни, зали для ігрових видів спорту: теніс, баскетбол, міні футбол)</li>
      </ul>

      <p class="text-[#61656F] lg:text-[18px] text-[16px] lato-s lg:leading-[28px] leading-[22px] lg:mb-[48px] mb-[18px]">
        Особливо важливим етапом для створення якісних і безпечних соціальних і спортивних будівель – є правильне і професійне проектування, а також високий рівень виробництва такої інжирної деревини з використанням сучасних технологій, зменшують ризики і роблять деревину ефективним і сталим вибором для соціальних і спортивних будівель.
      </p>
    </div>
