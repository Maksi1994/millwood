<template>
  <breadcrumbs  page="Індустріальні будівлі"/>
  ...
  <div class="mt-[20px] w-full">
    ...
    <div class="list">
      <ul>
        <li><strong>Швидше, тихіше та безпечніше:</strong> Це забезпечує значну економію часу та коштів.</li>
        <li><strong>Естетична привабливість:</strong> Клеєна конструкційна деревина має природний вигляд і може бути використана для створення вражаючих архітектурних форм і дизайну.</li>
        <li><strong>Відсутність компромісів:</strong> Незважаючи на сучасний і естетичний вигляд, ці конструкційні елементи забезпечують необхідну міцність і стабільність, відповідаючи всім нормативам і стандартам.</li>
        <li><strong>Покращені теплоізоляційні та екологічні властивості:</strong> Ваша конструкція стане комфортнішою для використання, незалежно від того, чи йдеться про житлові, індустріальні або соціальні будівлі.</li>
        <li><strong>Високі стандарти стійкості:</strong> Це допомагає зменшити вуглецевий слід проекту.</li>
      </ul>
    </div>
